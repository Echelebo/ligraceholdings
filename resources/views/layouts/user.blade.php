...
<body class="menuclose-right" style="position: relative; min-height: 100%; top: 0px;" >
  ...
  <header class="navbar-fixed">
    <nav class="navbar navbar-toggleable-md navbar-inverse bg-faded">
      ...
      <!-- <form class="form-inline mr-sm-2  pull-left search-header hidden-md-down"><input type="hidden" name="form_id" value="17433838121834"><input type="hidden" name="form_token" value="4c870abad3072926605232402feac650"><input type="hidden" name="form_id" value="16769561497483"><input type="hidden" name="form_token" value="9b67b46ce7dd773d3eefa39638303979">
    ...
    <ul class="nav flex-column in" id="side-menu" style="">
      ...
      <li class="title-nav">
        ...
        <ul class="nav flex-column nav-second-level ">
          ...
          </li><li class="nav-item"><a class="nav-link" href="{{ route('user.calendar.index') }}"><i class="fas fa-calendar-alt"></i> Market Calendar</a>
          </li>
        </ul>
        <!-- /.nav-second-level -->
      </li>
...
<script src="/trustvendor/cookie/jquery.cookie.js" type="text/javascript"></script>
...
<div class="mgm" style="display: block;">
<div class="txt" style="color:black;">Someone from <b>UK</b> has <b>withdrawn</b> <a href="javascript:void(0);" onclick="javascript:void(0);">£58,623</a></div>
</div>

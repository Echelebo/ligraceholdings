    ...
    <section class="banner_area">
        <div class="container">
            <div class="banner_text">
                <h4>Rules &amp; Agreements</h4>
                <a href="/">Home</a>
                <span>/</span>
                <a class="active" href="/tos">Rules</a>
            </div>
        </div>
    </section>
    <!--================End Banner Area =================-->
...
altsfolio.org is not available to the general public and is opened only to the qualified members of altsfolio.org, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the altsfolio.org and its Member.<br><br>
...
As a private transaction, this program is exempt from the US Securities Act of 1933, the US Securities Exchange Act of 1934 and the US Investment Company Act of 1940 and all other rules, regulations and amendments thereof. We are not FDIC insured. We are not a licensed bank or a security firm.<br><br>
 You agree that all information, communications, materials coming from altsfolio.org
...
All the data giving by a member to altsfolio.org will be only privately used and not disclosed to any third parties. altsfolio.org is not responsible or liable for any loss of data.<br><br>
...
altsfolio.org is not responsible or liable for any damages, losses and costs resulting from any violation of the conditions and terms and/or use of our website by a member. You guarantee to altsfolio.org that you will not use this site in any illegal way and you agree to respect your local, national and international laws.<br><br>
...
altsfolio.org reserves the right to accept or decline any member for membership without explanation.<br><br>
